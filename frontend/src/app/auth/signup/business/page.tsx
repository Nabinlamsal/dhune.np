        ...
        <div className="grid w-full max-w-6xl gap-6 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
            ...
            <section className="rounded-xl border border-border bg-card p-3 shadow-xl sm:p-4">
                <div className="mb-4 grid grid-cols-2 rounded-lg bg-muted p-1 text-sm font-semibold">
                    <Link className="rounded-md px-3 py-2 text-center text-muted-foreground hover:text-foreground" href="/auth/signup/user">User</Link>
                    <Link className="rounded-md bg-[#040947] px-3 py-2 text-center text-white" href="/auth/signup/business">Business</Link>
                </div>
                <BusinessSignupForm
