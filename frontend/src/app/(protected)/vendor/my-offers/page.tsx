    ...
    return (
        <>
            ...
            <div className="grid grid-cols-6 gap-4 mb-8">
                <StatCard title="Total" value={String(stats?.data.total_offers ?? 0)} trend={""} description={""} />
                <StatCard title="Pending" value={String(stats?.data.pending_offers ?? 0)} trend={""} description={""} />
                <StatCard title="Accepted" value={String(stats?.data.accepted_offers ?? 0)} trend={""} description={""} />
                <StatCard title="Rejected" value={String(stats?.data.rejected_offers ?? 0)} trend={""} description={""} />
                <StatCard title="Withdrawn" value={String(stats?.data.withdrawn_offers ?? 0)} trend={""} description={""} />
                <StatCard title="Expired" value={String(stats?.data.expired_offers ?? 0)} trend={""} description={""} />
            </div>
                ...
                {selectedOffer && (
                    <div className="space-y-6 text-sm">
                        ...
                        {selectedOffer.status === "ACCEPTED" && (
                            <div className="pt-6 border-t text-green-600 font-medium">
