...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 flex items-center justify-between h-13 bg-[#F7F5EE] text-[#1A1A2E] font-nunito font-semibold px-8 shadow-md">
      ...
      <div className="hidden md:flex justify-center">
        <div className="flex items-left space-x-8 text-sm">
          <a
            href="#"
      ...
      <div>
        <button onClick={() => router.push("/auth/login")} className="text-[#F7F5EE] text-xs h-7 px-4 rounded-lg bg-[#040947] hover:bg-[#25147bea] transition">
          Book Service
        </button>
      </div>
    </nav >
