          ...
          {flowSteps.map((step, index) => {
            ...
            return (
              <div key={step.title} className="relative">
                <motion.article
                  className="relative z-10 h-full rounded-[1.35rem] border border-slate-200 bg-white p-6 text-center shadow-sm transition hover:border-[#040947]/25 hover:shadow-xl hover:shadow-[#040947]/8 dark:border-white/10 dark:bg-white/[0.08] dark:hover:border-cyan-300/30 dark:hover:shadow-cyan-300/10"
                ...
                >
                  <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-[#040947] text-white shadow-lg shadow-[#040947]/15 dark:bg-cyan-300 dark:text-[#07111f] dark:shadow-cyan-300/15">
                ...
                {!isLast ? (
                  <>
                    <div className="absolute left-1/2 top-full z-0 flex h-4 -translate-x-1/2 items-center justify-center lg:left-auto lg:right-[-22px] lg:top-1/2 lg:h-auto lg:translate-x-0 lg:-translate-y-1/2">
                      ...
                      <ArrowRight className="hidden h-6 w-6 text-[#040947]/35 dark:text-cyan-200/45 lg:block" />
                    </div>
                    <div className="mx-auto h-5 w-px bg-[#040947]/15 dark:bg-cyan-200/20 lg:absolute lg:right-[-24px] lg:top-1/2 lg:mx-0 lg:h-px lg:w-12" />
                  </>
                ) : null}
              </div>
            );
